		...
		if(isset($_POST) && !empty($_POST))
		{
			if( (!empty($_POST['user_id']) && isset($_POST['user_id'])) && (!empty($headerStringValue['webservice_token'])) )
			{
				...
				if($validate['is_valid']==1)
				{
					...
					$investigation_recommendation_arr = $this->DM->getActionHygeineInvestigationRecommendation1($user_id);
					...
					$user_data['action_invite_list']['hygeine_investigation_recommendation'] = $investigation_recommendation_arr;
