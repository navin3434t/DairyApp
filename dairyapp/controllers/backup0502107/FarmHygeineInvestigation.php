		...
		if(isset($_POST) && !empty($_POST))
		{
			if( (!empty($_POST['user_id']) && isset($_POST['user_id'])) && (!empty($headerStringValue['webservice_token'])) && (!empty($_POST['investigationStep1']) && isset($_POST['investigationStep1'])) && (!empty($_POST['investigationStep2']) && isset($_POST['investigationStep2'])) && (!empty($_POST['investigationStep3']) && isset($_POST['investigationStep3'])) && (!empty($_POST['investigationStep4']) && isset($_POST['investigationStep4'])) && (!empty($_POST['investigationStep5']) && isset($_POST['investigationStep5'])) && (!empty($_POST['investigationStep6']) && isset($_POST['investigationStep6'])) && (!empty($_POST['investigationStep7']) && isset($_POST['investigationStep7'])) && (!empty($_POST['investigationStep8']) && isset($_POST['investigationStep8'])) && (!empty($_POST['investigationStep9']) && isset($_POST['investigationStep9'])) && (!empty($_POST['investigationStep10']) && isset($_POST['investigationStep10'])) && (!empty($_POST['bulkMilkTankCleaning']) && isset($_POST['bulkMilkTankCleaning'])) && (!empty($_POST['completeInvestigation']) && isset($_POST['completeInvestigation'])) && (!empty($_POST['investigationRecommendation1']) && isset($_POST['investigationRecommendation1'])) && (!empty($_POST['investigationRecommendation2']) && isset($_POST['investigationRecommendation2'])) && (!empty($_POST['investigationRecommendation3']) && isset($_POST['investigationRecommendation3'])) && (!empty($_POST['investigationRecommendation4']) && isset($_POST['investigationRecommendation4'])) )
			{
				...
				if($validate['is_valid']==1)
				{
					...
					$invite_data = $investigationStep1['invite_data'];
					...
					if($response_farm)
					{
						...
						if($response["is_insert"]=="1")
						{
							...
							/* Step3 Start */
							$water_details_s3 =  $investigationStep3['water_details'];
							$this->FHI->investigationStep3($water_details_s3,$fhi_id,$user_id);
							/* Step3 end */
							
							/* Step4 Start*/
							$equipment_inspection_s4 = $investigationStep4['equipment_inspection'];
							$response=$this->FHI->investigationStep4($equipment_inspection_s4,$fhi_id,$user_id);
							/* Step4 End*/
							
							/* Step5 Start*/
							$wash_assessment_cycle_s5 =$investigationStep5['wash_assessment_cycle'] ;
							$am_s3 = $investigationStep5['am'];
							$pm_s3 = $investigationStep5['pm'];
							$other_s3 = $investigationStep5['other'];
							$name_s3 = $investigationStep5['name'];
							$data_assement_s5=array('am'=>$am_s3,'pm'=>$pm_s3,'other'=>$other_s3,'name'=>$name_s3,'fhi_id'=>$fhi_id);
							$response=$this->FHI->investigationStep5($data_assement_s5,$wash_assessment_cycle_s5,$fhi_id,$user_id);
							/* Step5 End*/

							/* Step6 Start*/
							$cleaning_solution_s6 = $investigationStep6['cleaning_solution'];
							$this->FHI->investigationStep6($cleaning_solution_s6,$fhi_id,$user_id);
							/* Step6 End*/

							/* Step7 Start*/
							$liner_mouthpiece_s7 = $investigationStep7['liner_mouthpiece'];
							$liner_mouthpiece_yes_s7 = $investigationStep7['liner_mouthpiece_yes'];
							$liner_mouthpiece_no_s7 = $investigationStep7['liner_mouthpiece_no'];
							$which_unit_liner_s7 = $investigationStep7['which_unit_liner'];
							$which_unit_liner_description_s7 = $investigationStep7['which_unit_liner_description'];
							$cleaning_solution_flow_s7 = $investigationStep7['cleaning_solution_flow'];
							$cleaning_solution_flow_yes_s7 = $investigationStep7['cleaning_solution_flow_yes'];
							$cleaning_solution_flow_no_s7 = $investigationStep7['cleaning_solution_flow_no'];
							$which_unit_cleaning_s7 = $investigationStep7['which_unit_cleaning'];
							$which_unit_cleaning_description_s7 = $investigationStep7['which_unit_cleaning_description'];
							$working_vacuum_s7 = $investigationStep7['working_vacuum'];
							$working_vacuum_yes_s7 = $investigationStep7['working_vacuum_yes'];
							$working_vacuum_no_s7 = $investigationStep7['working_vacuum_no'];
							$vacuum_kevek_s7 = $investigationStep7['vacuum_kevek'];
							$vacuum_kevek_description_s7 = $investigationStep7['vacuum_kevek_description'];
							$effective_reserve_s7 = $investigationStep7['effective_reserve'];
							$effective_reserve_yes_s7 = $investigationStep7['effective_reserve_yes'];
							$effective_reserve_no_s7 =$investigationStep7['effective_reserve_no'] ;
							
							$data_arr_s7=array('liner_mouthpiece'=>$liner_mouthpiece_s3,'liner_mouthpiece_yes'=>$liner_mouthpiece_yes_s3,'liner_mouthpiece_no'=>$liner_mouthpiece_no_s3,'which_unit_liner'=>$which_unit_liner_s3,'which_unit_liner_description'=>$which_unit_liner_description_s3,'cleaning_solution_flow'=>$cleaning_solution_flow_s3,'cleaning_solution_flow_yes'=>$cleaning_solution_flow_yes_s3,'cleaning_solution_flow_no'=>$cleaning_solution_flow_no_s3,'which_unit_cleaning'=>$which_unit_cleaning_s3,'which_unit_cleaning_description'=>$which_unit_cleaning_description_s3,'working_vacuum'=>$working_vacuum_s3,'working_vacuum_yes'=>$working_vacuum_yes_s3,'working_vacuum_no'=>$working_vacuum_no_s3,'vacuum_kevek'=>$vacuum_kevek_s3,'vacuum_kevek_description'=>$vacuum_kevek_description_s3,'effective_reserve'=>$effective_reserve_s3,'effective_reserve_yes'=>$effective_reserve_yes_s3,'effective_reserve_no'=>$effective_reserve_no_s3,'fhi_id'=>$fhi_id,'create_date'=>date('Y-m-d'));
							$this->FHI->investigationStep7($data_arr_s7,$user_id);
							/* Step7 End*/

							/* Step8 Start*/
							$injector_yes_s8 = $investigationStep8['effective_reserve_no']$this->input->post("injector_yes");
							$injector_no_s8 = $investigationStep8['effective_reserve_no']$this->input->post("injector_no");
							$slug_wash_cycle_s8 = $investigationStep8['effective_reserve_no']$this->input->post("slug_wash_cycle");
							$estimated_slug_screen_s8 = $investigationStep8['estimated_slug_screen'];
							$receiver_volume_1_2l_s8 = $investigationStep8['receiver_volume_1_2l'];
							$receiver_volume_2_3_f_s8 = $investigationStep8['receiver_volume_2_3_f'];
							$receiver_volume_1_3_f_s8 = $investigationStep8['receiver_volume_1_3_f'];
							$receiver_volume_2_3_g_s8 = $investigationStep8['receiver_volume_2_3_g'];
							$receiver_volume_1_2_f_s8 = $investigationStep8['receiver_volume_1_2_f'];
							$after_turn_yes_s8 =$investigationStep8['after_turn_yes'] ;
							$after_turn_no_s8 = $investigationStep8['after_turn_no'];
							$instant_after_turn_yes_s8 = $investigationStep8['instant_after_turn_yes'];
							$instant_after_turn_no_s8 = $investigationStep8['instant_after_turn_no'];
							$before_turn_yes_s8 = $investigationStep8['before_turn_yes'];
							$before_turn_no_s8 = $investigationStep8['before_turn_no'];
							$little_no_action_yes_s8 = $investigationStep8['little_no_action_yes'];
							$little_no_action_no_s8 = $investigationStep8['little_no_action_no'];
							$good_action_yes_s8 = $investigationStep8['good_action_yes'];
							$good_action_no_s8 = $investigationStep8['good_action_no'];
							$little_action_yes_s8 = $investigationStep8['little_action_yes'];
							$little_action_no_s8 = $investigationStep8['little_action_no'];
							$other_yes_s8 = $investigationStep8['other_yes'];
							$other_no_s8 = $investigationStep8['other_no'];	

							$data_arr_s8=array('injector_yes'=>$injector_yes_s8,'injector_no'=>$injector_no_s8,'slug_wash_cycle'=>$slug_wash_cycle_s8,'estimated_slug_screen'=>$estimated_slug_screen_s8,'receiver_volume_1_2l'=>$receiver_volume_1_2l_s8,'receiver_volume_2_3_f'=>$receiver_volume_2_3_f_s8,'receiver_volume_1_3_f'=>$receiver_volume_1_3_f_s8,'receiver_volume_2_3_g'=>$receiver_volume_2_3_g_s8,'receiver_volume_1_2_f'=>$receiver_volume_1_2_f_s8,'after_turn_yes'=>$after_turn_yes_s8,'after_turn_no'=>$after_turn_no_s8,'instant_after_turn_yes'=>$instant_after_turn_yes_s8,'instant_after_turn_no'=>$instant_after_turn_no_s8,'before_turn_yes'=>$before_turn_yes_s8,'before_turn_no'=>$before_turn_no_s8,'little_no_action_yes'=>$little_no_action_yes_s8,'little_no_action_no'=>$little_no_action_no_s8,'good_action_yes'=>$good_action_yes_s8,'little_action_yes'=>$little_action_yes_s8,'little_action_no'=>$little_action_no_s8,'other_yes'=>$other_yes_s8,'good_action_no'=>$good_action_no_s8,'other_no'=>$other_no_s8,'fhi_id'=>$fhi_id,'create_date'=>date('Y-m-d'));
							$this->FHI->investigationStep8($data_arr_s8,$user_id);							
							/* Step8 End*/

							/* Step9 Start*/
							$pre_rinse_s9 = $investigationStep9['pre_rinse'];
							$wash_s9 = $investigationStep9['wash'];
							$average_flow_rate_s9 = $investigationStep9['average_flow_rate'];
							$final_rinse_s9 = $investigationStep9['final_rinse'];
							$allowance_s9 = $investigationStep9['allowance'];
							$flow_rate_unit_s9 = $investigationStep9['flow_rate_unit'];							
							
							$data_arr_s9=array('pre_rinse'=>$pre_rinse,'wash'=>$wash,'average_flow_rate'=>$average_flow_rate,'final_rinse'=>$final_rinse,'allowance'=>$allowance,'fhi_id'=>$fhi_id);
							$this->FHI->investigationStep9($data_arr_s9,$flow_rate_unit_s9,$fhi_id,$user_id);
							/* Step9 End*/

							/* Step10 Start*/
							$alkali_wash_ph_level_s10 = $investigationStep10['alkali_wash_ph_level'];
							$acid_wash_ph_level_s10 = $investigationStep10['acid_wash_ph_level'];
							$wash_active_s10 = $investigationStep10['wash_active'];
							$sanitiser_ph_level_s10 = $investigationStep10['sanitiser_ph_level'];
							$other_test_s10 = $investigationStep10['other_test'];
							$program_name_s10 = $investigationStep10['program_name'];
							$chlorine_level_s10 = $investigationStep10['chlorine_level'];					
							$milk_cycle_s10 = $investigationStep10['milk_cycle'];

							$milk_tank_arr_s10=array('alkali_wash_ph_level'=>$alkali_wash_ph_level_s10,'acid_wash_ph_level'=>$acid_wash_ph_level_s10,'wash_active'=>$wash_active_s10,'sanitiser_ph_level'=>$sanitiser_ph_level_s10,'other_test'=>$other_test_s10,'program_name'=>$program_name_s10,'chlorine_level'=>$chlorine_level_s10,'fhi_id'=>$fhi_id,'create_date'=>date('Y-m-d'));						
							$this->FHI->investigationStep10($milk_tank_arr_s10,$milk_cycle_s10,$fhi_id,$user_id);							

							/* Step10 End*/

							/* Step Bulk Milk Tank Cleaning Start*/
							$alkali_ph_level_s11 = $bulkMilkTankCleaning['alkali_ph_level'];
							$acid_ph_level_s11 = $bulkMilkTankCleaning['acid_ph_level'];
							$alkal_wash_active_s11 = $bulkMilkTankCleaning['alkal_wash_active'];
							$sanitizer_ph_level_s11 = $bulkMilkTankCleaning['sanitizer_ph_level'];
							$chlorine_level_s11 = $bulkMilkTankCleaning['chlorine_level'];	
							
							$milk_tank_arr_s11=array('alkali_ph_level'=>$alkali_ph_level_s11,'acid_ph_level'=>$acid_ph_level_s11,'alkal_wash_active'=>$alkal_wash_active_s11,'sanitizer_ph_level'=>$sanitizer_ph_level_s11,'chlorine_level'=>$chlorine_level_s11,'created_by'=>$user_id,'fhi_id'=>$fhi_id,'create_date'=>date('Y-m-d'));						
							$this->FHI->bulkMilkTankCleaning($milk_tank_arr_s11,$fhi_id,$user_id);
							/* Step Bulk Milk Tank Cleaning End*/							
							
							/* Step Complete Investigation Start*/
							$other_test_observation_s12 = $completeInvestigation['other_test_observation'];
							$data_arr_s12=array('other_test_observation'=>$other_test_observation_s12);						
							$this->FHI->completeInvestigation($data_arr_s12,$fhi_id);
							
							/* Step Complete Investigation End*/

							/* Step Recommendation 1 Start*/
							$action_data_s13 = $investigationRecommendation1['action_data'];
							$response=$this->FHI->investigationRecommendation1($action_data_s13,$fhi_id,$user_id);
							/* Step Recommendation 1 End*/

							/* Step Recommendation 2 Start*/
							$retain_existing_s14 = $investigationRecommendation2['retain_existing'];
							$invite_data_s14 = $investigationRecommendation2['invite_data'];
							$new_recommendation_s14 = $investigationRecommendation2['new_recommendation'];
							$reference_number_s14 = $investigationRecommendation2['reference_number'];
							$milking_machine_data_s14 = array("retain_existing"=>$retain_existing_s14,"new_recommendation"=>$new_recommendation_s14,"reference_number"=>$reference_number_s14,"fhi_id"=>$fhi_id,"create_date"=>date("Y-m-d"),"created_by"=>$user_id);
							$machine_wash_data_s14 = $investigationRecommendation2['machine_wash_data'];
							$this->FHI->investigationRecommendation2($milking_machine_data_s14,$machine_wash_data_s14,$fhi_id,$user_id);
							$this->FHI->sendInvite($invite_data_s14,$user_id,$fhi_id);
							/* Step Recommendation 2 End*/

							/* Step Recommendation 3 Start*/
							$retain_existing_s15 = $investigationRecommendation3['retain_existing'];
							$invite_data_s15 = $investigationRecommendation3['invite_data'];
							$new_recommendation_s15 = $investigationRecommendation3['new_recommendation'];
							$cycle_arr_s15 = $investigationRecommendation3['cycle_arr'];
							
							$recommend3_data_s15 = array("retain_existing"=>$retain_existing,"new_recommendation"=>$new_recommendation,"fhi_id"=>$fhi_id,"create_date"=>date("Y-m-d"),"created_by"=>$user_id);
							
							$this->FHI->investigationRecommendation3($recommend3_data_s15,$cycle_arr_s15,$fhi_id,$user_id);
							$this->FHI->sendInvite($invite_data_s15,$user_id,$fhi_id);
							/* Step Recommendation 3 End*/

							/* Step Recommendation 4 Start*/
							$action_data_s14 = $investigationRecommendation4['action_data'];
							$response=$this->FHI->investigationRecommendation4($action_data_s14,$fhi_id,$user_id);
