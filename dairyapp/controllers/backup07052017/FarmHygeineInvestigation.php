...
class FarmHygeineInvestigation extends Front_Controller {
	...
	********************************************/
	public function offlineFarmHygeineInvestigation()
	{
		...
		if(isset($_POST) && !empty($_POST))
		{
			if( (!empty($_POST['user_id']) && isset($_POST['user_id'])) && (!empty($headerStringValue['webservice_token'])) && ( isset($_POST['investigationStep1'])) && ( isset($_POST['investigationStep2'])) && ( isset($_POST['investigationStep3'])) && ( isset($_POST['investigationStep4'])) && ( isset($_POST['investigationStep5'])) && ( isset($_POST['investigationStep6'])) && ( isset($_POST['investigationStep7'])) && ( isset($_POST['investigationStep8'])) && ( isset($_POST['investigationStep9'])) && ( isset($_POST['investigationStep10'])) && ( isset($_POST['bulkMilkTankCleaning'])) && ( isset($_POST['completeInvestigation'])) && ( isset($_POST['investigationRecommendation1'])) && ( isset($_POST['investigationRecommendation2'])) && ( isset($_POST['investigationRecommendation3'])) && (isset($_POST['investigationRecommendation4'])) && (!empty($_POST['local_db_id']) && isset($_POST['local_db_id'])) )
			/*if( (!empty($_POST['user_id']) && isset($_POST['user_id'])) && (!empty($headerStringValue['webservice_token'])) && (!empty($_POST['investigationStep1']) && isset($_POST['investigationStep1'])) && (!empty($_POST['investigationStep2']) && isset($_POST['investigationStep2'])) && (!empty($_POST['investigationStep3']) && isset($_POST['investigationStep3'])) && (!empty($_POST['investigationStep4']) && isset($_POST['investigationStep4'])) && (!empty($_POST['investigationStep5']) && isset($_POST['investigationStep5'])) && (!empty($_POST['investigationStep6']) && isset($_POST['investigationStep6'])) && (!empty($_POST['investigationStep7']) && isset($_POST['investigationStep7'])) && (!empty($_POST['investigationStep8']) && isset($_POST['investigationStep8'])) && (!empty($_POST['investigationStep9']) && isset($_POST['investigationStep9'])) && (!empty($_POST['investigationStep10']) && isset($_POST['investigationStep10'])) && (!empty($_POST['bulkMilkTankCleaning']) && isset($_POST['bulkMilkTankCleaning'])) && (!empty($_POST['completeInvestigation']) && isset($_POST['completeInvestigation'])) && (!empty($_POST['investigationRecommendation1']) && isset($_POST['investigationRecommendation1'])) && (!empty($_POST['investigationRecommendation2']) && isset($_POST['investigationRecommendation2'])) && (!empty($_POST['investigationRecommendation3']) && isset($_POST['investigationRecommendation3'])) && (!empty($_POST['investigationRecommendation4']) && isset($_POST['investigationRecommendation4'])) ) */
			{
				...
				if($validate['is_valid']==1)
				{
					...
					$investigationRecommendation1=$_POST['investigationRecommendation1'];	$investigationRecommendation2=$_POST['investigationRecommendation2'];	$investigationRecommendation3=$_POST['investigationRecommendation3'];	$investigationRecommendation4=$_POST['investigationRecommendation4'];	$local_db_id=$_POST['local_db_id'];				
					...
					if($response_farm)
					{
						...
						if($response["is_insert"]=="1")
						{
							...
							if(!empty($investigationStep4))
							{
								...
								$response=$this->FHI->investigationStep4offline($equipment_inspection_s4,$fhi_id,$user_id,$local_db_id);
							}
							/* Step4 End*/
							...
							$response=$this->FHI->investigationStep5offline($data_assement_s5,$wash_assessment_cycle_s5,$fhi_id,$user_id,$local_db_id);
							}
							/* Step5 End*/
							...
							$data_arr_s7=array('liner_mouthpiece'=>$liner_mouthpiece_s7,'liner_mouthpiece_yes'=>$liner_mouthpiece_yes_s7,'liner_mouthpiece_no'=>$liner_mouthpiece_no_s7,'which_unit_liner'=>$which_unit_liner_s7,'which_unit_liner_description'=>$which_unit_liner_description_s7,'cleaning_solution_flow'=>$cleaning_solution_flow_s7,'cleaning_solution_flow_yes'=>$cleaning_solution_flow_yes_s7,'cleaning_solution_flow_no'=>$cleaning_solution_flow_no_s7,'which_unit_cleaning'=>$which_unit_cleaning_s7,'which_unit_cleaning_description'=>$which_unit_cleaning_description_s7,'working_vacuum'=>$working_vacuum_s7,'working_vacuum_yes'=>$working_vacuum_yes_s7,'working_vacuum_no'=>$working_vacuum_no_s7,'vacuum_kevek'=>$vacuum_kevek_s7,'vacuum_kevek_description'=>$vacuum_kevek_description_s7,'effective_reserve'=>$effective_reserve_s7,'effective_reserve_yes'=>$effective_reserve_yes_s7,'effective_reserve_no'=>$effective_reserve_no_s7,'fhi_id'=>$fhi_id,'create_date'=>date('Y-m-d'),'local_db_id'=>$local_db_id);
							...
							{
							$injector_yes_s8 = $investigationStep8['injector_yes'];
							$injector_no_s8 = $investigationStep8['injector_no'];
							$slug_wash_cycle_s8 = $investigationStep8['slug_wash_cycle'];
							...
							$response=$this->FHI->investigationRecommendation1offline($action_data_s13,$fhi_id,$user_id,$local_db_id);
							}
		...
		if(isset($_POST) && !empty($_POST))
		{
			if( (!empty($_POST['user_id']) && isset($_POST['user_id'])) && (!empty($headerStringValue['webservice_token'])) && (!empty($_POST['farm_id']) && isset($_POST['farm_id'])))
			{
				...
				if($validate['is_valid']==1){
					...
					$farm_id = $this->input->post("farm_id");
					$response = $this->FHI->getInvestigationList($farm_id);
					if($response)
					{	
						echo json_encode(array("status"=>"1","msg"=>"Data found","data"=>$response));
					}
					...
					{
						echo json_encode(array("status"=>"0","msg"=>"Date not found"));
					}
				}
				else{
					echo json_encode(array("status"=>"0","msg"=>"Not valid user"));
